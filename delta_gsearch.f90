...
real(kind=8)                    :: sumrate
integer                          :: p
real(kind=8) , dimension(1000,3)  :: secondminimum
integer      , dimension(1000,3)  :: sec_min_scan
integer  , dimension(1000,3)     :: firstmax_scan

integer :: scanmin

real(kind=8) , dimension(1000,3) :: firstmaximum
...
real(kind=8),dimension(1000,3)    :: min_step_en
integer     ,dimension(1000,3)    :: exec_scanstep

real(kind=8),dimension(1000)      :: firstmini
integer     ,dimension(1000)      :: scanmini
